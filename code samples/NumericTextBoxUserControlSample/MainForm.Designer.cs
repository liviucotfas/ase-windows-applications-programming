namespace NumericTextBoxUserControlSample
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ucNumericTextBox = new NumericTextBoxUserControlSample.NumericTextBoxUserControl();
			this.numericTextBoxUserControl1 = new NumericTextBoxUserControlSample.NumericTextBoxUserControl();
			this.SuspendLayout();
			// 
		...
		private NumericTextBoxUserControl ucNumericTextBox;
		private System.Windows.Forms.Button btnGetUserControlValue;
		private NumericTextBoxUserControl numericTextBoxUserControl1;
	}
}
